...
(function (global) {
  ...
  stats_total: 'Total de status',
  card_more_btn: 'Mais informações',
  card_open_aria: 'Ver {name}',
  card_img_alt: 'Arte de {name}',
  ability_hidden_short: 'oculta',
  tab_about: 'Sobre',
  tab_stats: 'Status',
  tab_abilities: 'Habilidades',
  tab_evolutions: 'Evoluções',
  tab_lore: 'Lore',
  sprite_official: 'Oficial',
  sprite_normal: 'Normal',
  sprite_shiny: 'Shiny',
  sprite_toggle_aria: 'Alternar sprite',
  type_matchups_heading: 'Tipagem defensiva',
  type_weak: 'Fraquezas',
  type_resist: 'Resistências',
  type_immune: 'Imunidades',
  ...
  bio_gender: 'Gênero',
  bio_capture: 'Captura',
  bio_happiness: 'Felicidade',
  bio_exp: 'Exp. base',
  ev_yield_heading: 'EV yield',
  moves_sample_heading: 'Golpes (nível)',
  lore_empty: 'Sem entrada da Pokédex disponível.',
  flavor_lang_note: 'idioma: {lang}',
  modules_load_failed: 'Não foi possível carregar os módulos da interface. Recarregue a página.',
  };
